...
public class Vista extends javax.swing.JFrame {
    ...
    ClaseProducto objProd = new ClaseProducto();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    objProd.setNombre(jTextField1.getText());
    objProd.setPrecioDeCosto(jTextField2.getText());
    objProd.setPrecioDeVenta(jTextField3.getText());
     
    jLabel6.setText("El producto " + jTextField1.getText() + " deja una ganancia de: S/. " + objProd.getGanancia());
